...
second, = ax1.plot(x_data[:8000], ore_data[:8000], color=colors[1], linestyle=linestyles[1], linewidth=2)
third, = ax1.plot(x_data[:950], strawman_data[:950], color=colors[2], linestyle=linestyles[2], linewidth=2)
ax1.legend([second, third], ['ORE','Strawman Max'], bbox_to_anchor=(0, 1), loc=3, ncol=3, handletextpad=0.3)
# ax1.xaxis.set_major_locator(ticker.MaxNLocator(5))

ax2 = fig.add_subplot(312)
ax2.plot(x_data[:255], ore_data[:255], color=colors[1], linestyle=linestyles[1], linewidth=2)
ax2.plot(x_data[:255], strawman_data[:255], color=colors[2], linestyle=linestyles[2], linewidth=2)
ax2.set_xlim(0,25000)

ax3 = fig.add_subplot(313)
ax3.plot(x_data[:55], ore_data[:55], color=colors[1], linestyle=linestyles[1], linewidth=2)
ax3.plot(x_data[:55], strawman_data[:55], color=colors[2], linestyle=linestyles[2], linewidth=2)
ax3.set_xlim(0,5000)
...
fig.text(0.5, 0.04, 'Chunk intervals', ha='center')
